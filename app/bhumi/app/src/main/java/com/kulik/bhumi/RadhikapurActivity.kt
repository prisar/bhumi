...
fun Greeting4(name: String) {
    Column(modifier = Modifier.padding(10.dp)) {
        ...
        Text(text = "Radhikapur has gathered tremendous attention in recent years. Every days flocks of people from towns come to visit which only a decade ago was totaly neglected.")
    }
}
